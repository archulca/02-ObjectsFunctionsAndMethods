...
def main():
    ...
    even_better_draw_circles(rg.Point(0,0),20,10,'blue',5)
    even_better_draw_circles(rg.Point(50,50),5,30,'magenta',2)
...
def even_better_draw_circles(point, d_radii, number_of_circles, color, thickness):
    turtle = rg.SimpleTurtle()
